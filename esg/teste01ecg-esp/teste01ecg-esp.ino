...
//Wifi configuration
String SSID = "AP01_VALLEY"; //name of the wifi network to connect
String NETWORK_PASSWORD = "amontada"; //password of the wifi network
String IP_ADDRESS = "192.168.177.1"; //ip address of the server. Example: "192.168.1.1"

//sensor authentication
String SENSOR_NAME = "ESP32_teste"; //sensor username
String SENSOR_PASSWORD = "@eplgfm22"; //sensor password
